...
def _generate_execution_report():
    ...
    script_name = "BBU_By_Customer_Weekly"
...
SCREENSHOT_DIR = r"Test_Screenshots/BBU_By_Customer_Weekly"
...
''')
    ...
    safe_action(page, page.get_by_role("textbox", name="Filter Columns Input"), 'press', "get_by_role(\"textbox\", name=\"Filter Columns Input\")", "Enter")
    safe_action(page, page.locator("#ag-839").get_by_text("System Forecast Total (Plan Week)"), 'click', "locator(\"#ag-839\").get_by_text(\"System Forecast Total (Plan Week)\")", )
    ...
    safe_action(page, page.get_by_role("textbox", name="Filter Columns Input"), 'fill', "get_by_role(\"textbox\", name=\"Filter Columns Input\")", "")
    safe_action(page, page.get_by_role("textbox", name="Filter Columns Input"), 'press', "get_by_role(\"textbox\", name=\"Filter Columns Input\")", "Enter")
    safe_action(page, page.locator("#ag-989 > .ag-column-panel > .ag-column-select > .ag-column-select-list > .ag-virtual-list-viewport > .ag-virtual-list-container > div > .ag-column-select-column").first, 'click', "locator(\"#ag-989 > .ag-column-panel > .ag-column-select > .ag-column-select-list > .ag-virtual-list-viewport > .ag-virtual-list-container > div > .ag-column-select-column\").first", )
    ...
    safe_action(page, page.get_by_text("System Forecast Total (Plan").nth(1), 'click', "get_by_text(\"System Forecast Total (Plan\").nth(1)", )
    safe_action(page, page.get_by_text("System Forecast Total (Plan").nth(1), 'click', "get_by_text(\"System Forecast Total (Plan\").nth(1)", )
    safe_action(page, page.get_by_text("System Forecast Total (Plan").nth(1), 'click', "get_by_text(\"System Forecast Total (Plan\").nth(1)", )
